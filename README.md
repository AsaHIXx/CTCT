...
1. sparse_50318_for_26types.npz (primary tumors with 26 cell types, can be searched and downloaded from `https://drive.google.com/file/d/1oZKOdY-dZCT3LYqvGjSTLVAl78XlKLl0/view`)
...
- if you want to reproduce training process, you need to download the source dataset used in this study(sparse_50318_for_26types.npz) from the website(`https://drive.google.com/file/d/1oZKOdY-dZCT3LYqvGjSTLVAl78XlKLl0/view`).
